...
import jp.cron.sample.api.service.osu.OsuActivityWatcher;
import jp.cron.sample.api.service.osu.OsuGateway;
...
public class GeneralListener extends ListenerAdapter {
    ...
    @Autowired
    OsuActivityWatcher activityWatcher;
    ...
    public void onReady(@NotNull ReadyEvent event) {
        ...
        event.getJDA().getPresence().setPresence(Activity.playing("お前らを監視しています..."), false);

        activityWatcher.jda = event.getJDA();
    }
